...
#define _HID_CLASS_COMMON_H_
	...
	/* Macros: */
        ...
        #define HID_DESCRIPTOR_DIGITIZER()                  \
	        HID_RI_USAGE_PAGE(8, DIGITIZER),                \
			HID_RI_USAGE(8, USAGE_TOUCH_SCREEN),            \
			HID_RI_COLLECTION(8, 0x01),                     \
				HID_RI_USAGE(8, 0x22),                      \
...
\
		 ...
		 */
            ...
            // Setting this up as a digitizer is a hack to get the screen working in windows. 

            #define HID_DESCRIPTOR_DIGITIZER(TYPE, RES_X, RES_Y)  \
...
\
			        HID_RI_USAGE_PAGE(8, GENERIC_DESKTOP),  \
			        HID_RI_LOGICAL_MAXIMUM(16, RES_X),      \
			        HID_RI_REPORT_SIZE(8, 0x10),            \
			        HID_RI_UNIT_EXPONENT(8, 0x0e),          \
			        HID_RI_UNIT(8, 0x11),                   \
			        HID_RI_USAGE(8, USAGE_X),               \
			        HID_RI_PHYSICAL_MINIMUM(8, 0),          \
			        HID_RI_PHYSICAL_MAXIMUM(16, 6600),      \
			        HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE), \
\
			        HID_RI_PHYSICAL_MAXIMUM(16, 9400),      \
                    HID_RI_LOGICAL_MAXIMUM(16, RES_Y),      \
			        HID_RI_USAGE(8, USAGE_Y),               \
			        HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE), \
				HID_RI_END_COLLECTION(0),                   \
			HID_RI_END_COLLECTION(0)
